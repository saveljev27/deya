  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content={intl.formatMessage({ id: "meeting.meta.description" })} />
        <link rel="alternate" href={`${baseUrl}/nl-NL/meeting-planned`} hrefLang="nl" />
        <link rel="alternate" href={`${baseUrl}/meeting-planned`} hrefLang="en" />

        <meta property="og:type" content="website" key="metaTypeFb" />
        <meta property="og:title" content={intl.formatMessage({ id: "meeting.meta.title" })} key="ogTitle" />
        <meta property="og:description" content={intl.formatMessage({ id: "meeting.meta.description" })} key="ogDescription" />
        ...
        <meta name="twitter:title" content={intl.formatMessage({ id: "meeting.meta.title" })} key="metaTitleTw" />
        <meta name="twitter:description" content={intl.formatMessage({ id: "meeting.meta.description" })} key="metaDescriptionTw" />
            ...
            <div className="col-12">
              ...
              <div className="row mt-4">
                ...
                <div className="col-12 col-md-8">
                  {intl.formatMessage({ id: "meeting.body" })}
                </div>
              </div>
              <div className="row mt-4">
